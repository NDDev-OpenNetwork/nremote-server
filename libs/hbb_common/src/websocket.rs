...
pub fn check_ws(endpoint: &str) -> String {
    ...
    let (relay, dst_port) = if endpoint_port == rendezvous_port {
        ...
        // relay
        // The relay WebSocket listener is the relay port plus two; see hbbr,
        // which binds PORT and PORT+2 for exactly this pairing.
...
mod tests {
    ...
    fn test_check_ws() {
        ...
        assert_eq!(check_ws("example.com:21117"), "wss://example.com/ws/relay");
        ...
        assert_eq!(check_ws("example.com:21115"), "wss://example.com/ws/id");
        assert_eq!(check_ws("example.com:21116"), "wss://example.com/ws/id");
        assert_eq!(check_ws("example.com:34567"), "wss://example.com/ws/relay");
